                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input
                                ...
                                value="<?= isset($data) && is_object($data) ? $data->telefono_us : ''; ?>"
                        >
                    </div>
                    <div class="form-group">
                        ...
                        <input
                                ...
                                id="email"
                                placeholder="email"
                                value="<?= isset($data) && is_object($data) ? $data->email : ''; ?>"
                        >
                    </div>
                    <?php if (!isset($data)): ?>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        ...
                        <input type="submit" value="Guardar" class="btn sm-color btn-sm"/>
                    </div>
            </form>
        </div>
    </div>
                            ...
                            <div class="status-user">
                                <label for="">
                                    <input type="text" name="" id="estado_us"
                                           value="<?= isset($data) && $data->status_us == 1 ? 'ACTIVO' : 'INACTIVO' ?>">
                                </label>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group clearfix">
                                    <div class="icheck-info d-inline">
                                        <input id="checkboxPrimary1" type="checkbox"
                                               data-v="<?= $data->id_usuario ?>" <?= isset($data) && $data->status_us == 1 ? 'checked' : '' ?>>
